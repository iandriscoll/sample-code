...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    if score0 == 1 or score1 == 1 or score0 == 0 or score1 == 0:
        return False
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def f(score0, score1, pre=previous_score, prehigh=previous_high):
        if who == 0:
            score = score0
        else:
            score = score1
        curr_high = score - pre
        if curr_high > prehigh:
            prehigh = curr_high
            if curr_high == 1:
                print(str(curr_high), "point! That's the biggest gain yet for Player", str(who))
            elif curr_high > 1:
                print(str(curr_high), "points! That's the biggest gain yet for Player", str(who))
        return announce_highest(who, prehigh, score)
    return f
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if is_swap(score, opponent_score) and score < opponent_score or free_bacon(opponent_score) >= margin:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
