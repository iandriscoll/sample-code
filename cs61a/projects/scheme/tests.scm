...
(define (fun x) (print x))
; expect fun
(fun 5)
; expect 5
fun
; expect (lambda (x) (print x))
...
(if (and true false) True False)

;expect #f

(if (or false true) True False)
...
(cond
  ...
  ((cond (4 0) (0 False)) True)

  (else False))

;expect #t

(cond (#f 'false) (True 100))
